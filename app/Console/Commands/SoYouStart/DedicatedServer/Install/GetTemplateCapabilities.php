...
class GetTemplateCapabilities extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'soyoustart:dedicatedserver:install:gettemplatecapabilities {serviceName : Service name} {templateName : Template name}';
     ...
     * @var string
     */
    protected $description = 'Get installation template capabilities';
    ...
    public function handle()
    {
        ...
        $result = $ovh_api->dedicatedServer->install->templateCapabilities($serviceName, $templateName);
